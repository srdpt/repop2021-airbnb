...
map.on("load", () => {
            ...
            features: [
                {
                    ...
                    geometry: {
                        type: "Point",
                        coordinates: [12.335904, 45.438063],
                    },
                },
                {
                    type: "Feature",
                    properties: {
                        name: "Academia Bridge",
                    },
                    geometry: {
                        type: "Point",
                        coordinates: [12.328941, 45.431668],
                    },
                },
                {
                    type: "Feature",
                    ...
                    geometry: {
                        type: "Point",
                        coordinates: [12.323029, 45.425772],
                    },
                },
                {
                    type: "Feature",
                    ...
                    geometry: {
                        type: "Point",
                        coordinates: [12.338415378081947, 45.4341551654546],
                    },
                },
                {
                    type: "Feature",
                    ...
                    geometry: {
                        type: "Point",
                        coordinates: [12.364012053821966, 45.42779161973161],
                    },
                },
            ],
        },
    ...
    map.on("click", (e) => {
        ...
        if (selectedService == btnTravel && markers.length < 2) {
            if (markers.length == 0) {
                inputStart.value = `${e.lngLat.lat.toFixed(
                    6
                )}, ${e.lngLat.lng.toFixed(6)}`;
                console.log(e.lngLat);
            } else {
                inputEnd.value = `${e.lngLat.lat.toFixed(
                    6
                )}, ${e.lngLat.lng.toFixed(6)}`;
            }
